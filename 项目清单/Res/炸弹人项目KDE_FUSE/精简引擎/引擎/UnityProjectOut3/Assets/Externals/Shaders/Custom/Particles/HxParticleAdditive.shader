...
//Adia
Shader "Fuse/Custom/Particles/Additive" {
//Adia
Properties {
...
//Adia
    ...
    _TextureTilingOffset ("Texture Tiling Offset", Vector) = (1, 1, 0, 0)
//Adia
}
...
//Adia
                col.a = saturate(col.a); //Adia

                UNITY_APPLY_FOG_COLOR(i.fogCoord, col, fixed4(0,0,0,0)); //Adia
                return col;
            }
            ENDCG
        }
...
//Adia
    CustomEditor "HxParticleAdditiveShaderGUI"
//Adia
}
