...
//Adia
Shader "Fuse/Custom/Particles/Alpha Blend Premultiply" {
//Adia
Properties {
//Adia
...
//Adia
                fixed4 col = _ColorStrength * i.color * tex2D(_MainTex, i.texcoord) * i.color.a;
...
//Adia
    CustomEditor "HxParticleAlphaBlendPremultiplyShaderGUI"
//Adia
}
