...
//Adia
Shader "Hidden/Fuse/Custom/SSS/SssCustomLightingPass"
//Adia
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma target 3.0
		//Adia
		#include "Assets/Scripts/Plugins/SSS/Resources/SSS_Common.hlsl"
		//Adia
...
#define TRANSMISSION
			...
			//Adia
			//Adia
			col *= lerp(float3(1.0, 1.0, 1.0), tex2D(_SubsurfaceAlbedo, uv).rgb, _SubsurfaceAlbedoOpacity);
			//Adia
#endif
			...
			if( SSS_shader != 1 ) {
				...
				//Adia
				Final = col * OcclusionColored.rgb * tex2D(_SssMap, uv) * _SssScale;
				//Adia
			}
