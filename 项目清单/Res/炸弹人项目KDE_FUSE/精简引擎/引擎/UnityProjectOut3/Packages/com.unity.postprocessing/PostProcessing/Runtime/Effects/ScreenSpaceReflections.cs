...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    internal sealed class ScreenSpaceReflectionsRenderer : PostProcessEffectRenderer<ScreenSpaceReflections>
    {
        ...
        // ↓ Add by Hexadrive.
        //-----------------------------------------------------------
        //!	@brief	レンダーテクスチャーが指定と違うなら作り直す
        //!	@param	[in/out]	rt				レンダーテクスチャー
        //!	@param	[in]		width			幅
        //!	@param	[in]		height			高さ
        //!	@param	[in]		filterMode		フィルターモード
        //!	@param	[in]		useMipMap		ミップマップを使うか
        ...
        {
            // ↓ Modify by Hexadrive.
            CheckRT(ref rt, width, height, filterMode, useMipMap, RuntimeUtilities.defaultHDRRenderTextureFormat);
            // ↑ Modify by Hexadrive.
        }
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            CheckRT(ref m_Resolve, size, size, FilterMode.Trilinear, true, context.sourceFormat);
			// ↓ Modified by Hexadrive.
