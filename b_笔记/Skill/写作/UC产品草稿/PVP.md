...
- 演绎讨论：
  - 按人称分类（公理）：
    - 第一人称描述：
      ...
      - 增强个人性格
      - 建立亲近感
      - 增强叙事的张力，感受到情节的发展和高潮的到来。
      - 负面效果：可能会导致作品过于主观，丧失客观性或普适性。
    - 第二人称描述：
      - 直接参与感：更容易沉浸于故事情节或观点中
      - 个性化：强调读者的个体和独特性
      - 强调互动：加强与读者的交流和参与
      - 接受指令/指导：教程、操作指南或使用说明
      - 负面效果：过度使用第二人称描述可能会给读者带来不适或疏离感。
    - 第三人称描述：
      - 客观性：
        - 第三人称描述更加客观，因为它与作者的主观情感和观点无关。
        - 这种客观性使得读者更容易接受和相信所描述的情节和人物。
      - 万能性：
        - 它可以提供一种中立的叙述声音，使得内容更具通用性和普遍适用性。
      - 视角转换：
        - 使得故事更加多元化和有趣。读者可以通过不同人物的视角来了解更多的信息和情节。
      - 距离感：
        - 读者可以更客观地分析和评估情节和人物，而不会受到作者个人情感的干扰。
      - 负面效果：
        - 1. 第三人称描述无法直接展示人物的内心思想和感受，这一点可能导致读者无法完全理解和共情。
        - 2. 使用第三人称描述可能会导致在不同角色之间的切换和平衡上的困难。这可能会导致读者在跟随故事时感到困惑或注意力不集中。
  - 我们游戏中的叙事角色（个例）
    - 科学家的声音：
      - 直接和玩家对话，引导玩家。
      - 用法：
    ...
    - 科学家女友的声音：
      ...
      - 战斗的策略、技巧和结果。
    - 玩家 自我 的声音：
      - 自我是个体的实际自我，是对现实的认识和应对的一种机制。
      - 努力满足 本我 和 超我 之间的冲突和要求。
      - 用法：
        - 描述战斗参与者的内心思绪、紧张情绪和背后的决策.
    - 玩家 本我 的声音：
      - 原始和无意识的部分。
      - 代表着基本的冲动和欲望。
      - 本我追求即时满足和快乐，不受道德准则和社会规范的约束。
      - 用法:
        - 战斗高潮时的内心本能满足。
    - 玩家 超我 的声音：
      - 代表着社会和文化对个体的规范和期望。
      - 超我形成于个体成长过程中，受到父母、教育和社会价值观的影响。
      - 它试图约束自我和本我的冲动，通过道德和道德标准来控制个体的行为。
      - 用法：
        - 描述果实特征，使得战斗更加丰富和有层次感。
  - 人称手法，对号入座（结论）
    - 自我：白色，代表理性
    - 本我：红色，代表冲动 加一些颤抖
    - 超我：蓝色，代表道德 加一些光晕
    - 科学家：绿色，代表科学 加一些鬼影
    - 科学家女友：紫色，代表神秘 加一些光晕
- 使用第三人称描述可以提供客观、中立的观察，描述战斗的场景和行动。这种写作方式通常适用于较为正式和客观的描述，可以注重战斗的策略、技巧和结果。
## ---
