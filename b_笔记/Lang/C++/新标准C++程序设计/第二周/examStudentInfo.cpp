...
int main ()
{
      ...
      StudentInfo sp;
      sp.Init(strsCin.at(0),(unsigned int)stoi(strsCin.at(1)),strsCin.at(2),(unsigned int)stoi(strsCin.at(3)),(unsigned int)stoi(strsCin.at(4)),(unsigned int)stoi(strsCin.at(5)),(unsigned int)stoi(strsCin.at(6)));
      sp.Print();
      return 0;
}